...
## 🧩 Activities
- Observed the lecturer’s demonstration of PC assembly and disassembly  
...
## 🧠 Reflection
As a first-year student, the PC Assembly and Disassembly Lab Session was a truly eye-opening experience for me. It was my first time opening up a computer and seeing its internal components up close. The instructor took us through the process and showed how to handle sensitive hardware like motherboard, RAM, power supply, and hard disk with care. Watching the demonstration made me realise how much precision and care are required when dealing with computer parts.
...
- Include more time for hands-on practice so every student can handle more components individually<br>
- Provide extra tools or equipment sets to reduce waiting time during group work<br>
- Add a short troubleshooting segment (e.g., PC fails to boot — identify the cause) to strengthen real-world problem-solving skills<br>
- Share a brief guide or checklist for students to review before and after the lab<br>
